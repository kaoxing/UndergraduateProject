...
nnUNet_raw = r"D:\pythonProject\UndergraduateProject\data\nnUNet_data\nnUNet_raw"
nnUNet_preprocessed = r"D:\pythonProject\UndergraduateProject\data\nnUNet_data\nnUNet_preprocessed"
nnUNet_results = r"D:\pythonProject\UndergraduateProject\data\nnUNet_data\nnUNet_results"
...
if __name__ == '__main__':
    ...
    merge_boundaries_with_seg(str(out_labels_dir), str(out_labels_dir).replace('labelsTr', 'labelsTr_edge'))
    print("All done.")
