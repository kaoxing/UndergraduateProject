...
dataset_name = f"Dataset600_MMWHS2017"
...
def copy_files_mri():
    ...
    for file in tqdm(os.listdir(mr_train_dir)):
        if 'image' in file:
            shutil.copy(
                os.path.join(mr_train_dir, file),
    ...
    # copy mri test files
    for file in tqdm(os.listdir(mr_test_dir)):
        if 'image' in file:
            shutil.copy(
                os.path.join(mr_test_dir, file),
    ...
    for file in tqdm(os.listdir(ct_train_dir)):
        if 'image' in file:
            shutil.copy(
                ...
                os.path.join(out_train_dir, file.replace("_image", "_0001"))
            )
        elif 'label' in file:
            shutil.copy(
                os.path.join(ct_train_dir, file),
    ...
    for file in tqdm(os.listdir(ct_test_dir)):
        if 'image' in file:
            shutil.copy(
                ...
                os.path.join(out_test_dir, file.replace("_image", "_0001"))
            )
